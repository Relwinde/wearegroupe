...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-7 offset-md-5 text-right caption mt-60 animate-box" data-animate-effect="fadeInUp">
                    <h5>Fashion</h5>
                    <h1>Basics of Modeling</h1>
                    <p><a href="blog.html">Blog</a> / Basics of Modeling</p>
                </div>
            </div>
        </div>
    </header>
    ...
    <section class="section-padding">
        <div class="container">
            <div class="row">
                <div class="col-md-12 animate-box" data-animate-effect="fadeInUp"> <img class="mb-30" src="img/blog/post.jpg" alt="">
            ...
            <div class="jophoto-comment-section">
                <div class="row">
                    <!-- Comment -->
                    <div class="col-md-7 col-sm-7">
                        <div class="jophoto-post-comment-wrap">
                            <div class="jophoto-user-comment"> <img src="img/team/p.png" alt=""> </div>
                            <div class="jophoto-user-content">
                                <h3>Lauren Misse<span> 29 October 2022</span></h3>
                                <p>Photography ultricies nibh non dolor maximus sceleue. Integer molliser faubs neque nec tincidunte. Aliquam erat volutpat. Praeser tempor malade quam, nec rutrum arcu ornare yapta. </p> <a class="jophoto-repay" href="#">Reply<i class="ti-back-left"></i></a> </div>
                        </div>
                    </div>
                    <!-- Contact Form -->
                    <div class="col-md-5 col-sm-5">
                        ...
                        <form method="post" class="row">
                            ...
                            <div class="col-sm-12">
                                <button class="butn-dark mt-10" type="submit">Post Comment</button>
                            </div>
                        </form>
                    </div>
                </div>
